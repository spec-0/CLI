...
const ENV_VARS = [
  "SPEC0_TOKEN", "SPEC0_ORG_ID",
  "PLATFORM_API_TOKEN", "PLATFORM_ORG_ID",
  "GITHUB_ACTIONS", "GITHUB_SHA", "GITHUB_REF_NAME", "GITHUB_REPOSITORY", "GITHUB_REPOSITORY_OWNER",
  "GITLAB_CI", "CI_COMMIT_SHA", "CI_COMMIT_REF_NAME", "CI_PROJECT_PATH", "CI_PROJECT_NAMESPACE",
  "BITBUCKET_BUILD_NUMBER", "BITBUCKET_COMMIT", "BITBUCKET_BRANCH", "BITBUCKET_WORKSPACE", "BITBUCKET_REPO_SLUG",
] as const;
