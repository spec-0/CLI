...
- `spec0 api delete <ref>` — soft delete. **Blocked**: requires a delete API on the public surface.
...
- `spec0 mock delete <api>` — remove mock server. **Blocked**: requires a delete-mock API on the public surface.
